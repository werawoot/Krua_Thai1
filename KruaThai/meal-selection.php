 ...
 * Description: เลือกเมนูอาหารตามจำนวนแพ็กเกจ (Step 2)
 */
...
try {
    ...
    if (!$plan) {
        ...
        $plans = [
            '74c0ed20-5afc-11f0-8b7f-3f129bd34f14' => ['id' => '74c0ed20-5afc-11f0-8b7f-3f129bd34f14', 'name_thai' => 'แพ็กเกจ 4 มื้อ', 'meals_per_week' => 4, 'final_price' => 499],
            'd6e98c56-5afb-11f0-8b7f-3f129bd34f14' => ['id' => 'd6e98c56-5afb-11f0-8b7f-3f129bd34f14', 'name_thai' => 'แพ็กเกจ 8 มื้อ', 'meals_per_week' => 8, 'final_price' => 899],
            'd6e98d96-5afb-11f0-8b7f-3f129bd34f14' => ['id' => 'd6e98d96-5afb-11f0-8b7f-3f129bd34f14', 'name_thai' => 'แพ็กเกจ 12 มื้อ', 'meals_per_week' => 12, 'final_price' => 1499],
            'd6e98e7c-5afb-11f0-8b7f-3f129bd34f14' => ['id' => 'd6e98e7c-5afb-11f0-8b7f-3f129bd34f14', 'name_thai' => 'แพ็กเกจ 15 มื้อ', 'meals_per_week' => 15, 'final_price' => 1799],
            // Support old IDs
            '4' => ['id' => '4', 'name_thai' => 'แพ็กเกจ 4 มื้อ', 'meals_per_week' => 4, 'final_price' => 499],
            '8' => ['id' => '8', 'name_thai' => 'แพ็กเกจ 8 มื้อ', 'meals_per_week' => 8, 'final_price' => 899],
            '12' => ['id' => '12', 'name_thai' => 'แพ็กเกจ 12 มื้อ', 'meals_per_week' => 12, 'final_price' => 1499],
            '15' => ['id' => '15', 'name_thai' => 'แพ็กเกจ 15 มื้อ', 'meals_per_week' => 15, 'final_price' => 1799]
        ];
    ...
    $plan = ['id' => $plan_id, 'name_thai' => 'แพ็กเกจที่เลือก', 'meals_per_week' => 8, 'final_price' => 899];
    $menus = [
        ['id' => '74184fca-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Pad Thai (Shrimp)', 'name_thai' => 'ผัดไทยกุ้ง', 'base_price' => 120, 'category_name' => 'Rice Bowls', 'category_name_thai' => 'ข้าวกล่อง', 'description' => 'Classic Pad Thai with shrimp, tofu, and peanuts.'],
        ['id' => '741955aa-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Pad Thai (Vegan)', 'name_thai' => 'ผัดไทยเจ', 'base_price' => 110, 'category_name' => 'Rice Bowls', 'category_name_thai' => 'ข้าวกล่อง', 'description' => 'Vegan Pad Thai with tofu, vegetables, and peanuts.'],
        ['id' => '74195a82-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Thai Basil (Chicken) + Rice', 'name_thai' => 'ผัดกะเพราไก่', 'base_price' => 115, 'category_name' => 'Rice Bowls', 'category_name_thai' => 'ข้าวกล่อง', 'description' => 'Spicy chicken stir-fried with basil, served with rice.'],
        ['id' => '74195c1c-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Green Curry (Chicken) + Rice', 'name_thai' => 'แกงเขียวหวานไก่', 'base_price' => 125, 'category_name' => 'Thai Curries', 'category_name_thai' => 'แกงไทย', 'description' => 'Mildly spicy green curry with chicken and rice.'],
        ['id' => '74195d7a-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Vegan Larb (Tofu)', 'name_thai' => 'ลาบเต้าหู้', 'base_price' => 100, 'category_name' => 'Rice Bowls', 'category_name_thai' => 'ข้าวกล่อง', 'description' => 'Northeastern style spicy tofu salad.'],
        ['id' => '74195ed8-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Cashew Chicken + Rice', 'name_thai' => 'ไก่ผัดเม็ดมะม่วง', 'base_price' => 120, 'category_name' => 'Rice Bowls', 'category_name_thai' => 'ข้าวกล่อง', 'description' => 'Chicken stir-fried with cashews and vegetables, served with rice.'],
        ['id' => '74196068-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Tom Kha (Chicken) + Rice', 'name_thai' => 'ต้มข่าไก่', 'base_price' => 115, 'category_name' => 'Thai Curries', 'category_name_thai' => 'แกงไทย', 'description' => 'Coconut milk soup with chicken and herbs, served with rice.'],
        ['id' => '74196cac-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Beef Crying Tiger + Sticky Rice', 'name_thai' => 'เนื้อเสือร้องไห้', 'base_price' => 145, 'category_name' => 'Rice Bowls', 'category_name_thai' => 'ข้าวกล่อง', 'description' => 'Grilled beef with spicy dipping sauce, served with sticky rice.'],
        ['id' => '7419d55c-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Tom Yum (Shrimp) soup', 'name_thai' => 'ต้มยำกุ้ง', 'base_price' => 130, 'category_name' => 'Thai Curries', 'category_name_thai' => 'แกงไทย', 'description' => 'Spicy and sour shrimp soup with Thai herbs.'],
        ['id' => '7419d89a-57ba-11f0-a23d-e6c5297ffe7c', 'name' => 'Chicken Satay', 'name_thai' => 'สะเต๊ะไก่', 'base_price' => 105, 'category_name' => 'Rice Bowls', 'category_name_thai' => 'ข้าวกล่อง', 'description' => 'Grilled chicken skewers served with peanut sauce.']
    ];
    $categories = [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'proceed_to_checkout') {
    ...
    if (!is_array($selected_meals)) {
        echo json_encode(['success' => false, 'message' => 'ข้อมูลเมนูไม่ถูกต้อง กรุณาลองใหม่อีกครั้ง']);
        exit;
    }
    
    if (count($selected_meals) !== (int)$plan['meals_per_week']) {
        echo json_encode(['success' => false, 'message' => 'กรุณาเลือกเมนูให้ครบ ' . $plan['meals_per_week'] . ' มื้อ (เลือกแล้ว ' . count($selected_meals) . ' มื้อ)']);
        exit;
    }
    ...
    echo json_encode(['success' => true, 'redirect' => 'checkout.php', 'message' => 'กำลังนำคุณไปยังหน้าชำระเงิน...']);
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>เลือกเมนูอาหาร | Krua Thai</title>
        ...
        <div class="meals-grid" id="mealsGrid">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <a href="subscribe.php" style="margin-top: 1rem; display: inline-block; padding: 0.8rem 1.5rem; background: var(--curry); color: var(--white); text-decoration: none; border-radius: var(--radius-md);">กลับเลือกแพ็กเกจ</a>
                </div>
            <?php endif; ?>
        </div>
