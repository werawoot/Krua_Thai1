    ...
    if ($action === 'update_profile') {
        ...
        if (empty($errors)) {
            ...
            if (isset($connection) && mysqli_ping($connection)) {
                ...
                if ($update_stmt) {
                    mysqli_stmt_bind_param($update_stmt, "ssssss", $first_name, $last_name, $phone, $date_of_birth, $gender, $user_id);
        ...
        <div class="profile-layout">
            ...
            <div class="profile-sidebar">
                <div class="sidebar-menu">
                    ...
                    <button class="menu-item" data-tab="address">
                        <span class="menu-icon">📍</span>
                        <span class="menu-text">ที่อยู่จัดส่ง</span>
                    </button>
            ...
            <div class="profile-content">
                ...
                <form method="POST" class="profile-form" id="profileForm">
                    ...
                    <div style="text-align: center; padding: 3rem; color: var(--gray);">
                            ...
                            <h3>กำลังพัฒนา</h3>
                            <p>ฟีเจอร์จัดการที่อยู่จัดส่งจะพร้อมใช้งานเร็วๆ นี้</p>
                        </div>
                    </div>
