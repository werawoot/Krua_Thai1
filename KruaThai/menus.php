...
<head>
    ...
    <title>เมนูอาหาร - Krua Thai | อาหารไทยเพื่อสุขภาพ</title>
    <meta name="description" content="เลือกชมเมนูอาหารไทยเพื่อสุขภาพจาก Krua Thai พร้อมข้อมูลโภชนาการและราคา">
    ...
    <header>
        <nav class="container">
            ...
            <div class="nav-links">
                ...
                <a href="menus.php">เมนูทั้งหมด</a>
                <?php if ($is_logged_in): ?>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="page-header">
                <h1 class="page-title">เมนูอาหารไทยเพื่อสุขภาพ</h1>
                <p class="page-subtitle">
                    เลือกชมเมนูอาหารไทยต้นตำรับที่ปรับปรุงให้เหมาะกับสุขภาพ 
                    พร้อมข้อมูลโภชนาการที่ครบครัน
                </p>
            </div>
                ...
                <form method="GET" action="" id="filterForm">
                    <div class="filters-grid">
                        <div class="filter-group">
                            <label class="filter-label">ค้นหาเมนู</label>
                            <input type="text" 
                                   name="search" 
                                   class="filter-input" 
                                   placeholder="ชื่อเมนู, คำอธิบาย..." 
                        ...
                        <div class="filter-group">
                            <label class="filter-label">ประเภทอาหาร</label>
                        ...
                        <div class="filter-group">
                            <label class="filter-label">ระดับความเผ็ด</label>
                            <select name="spice" class="filter-select">
                                <option value="">ทุกระดับ</option>
                                <option value="mild" <?php echo ($spice == 'mild') ? 'selected' : ''; ?>>ไม่เผ็ด</option>
                                <option value="medium" <?php echo ($spice == 'medium') ? 'selected' : ''; ?>>กลาง</option>
                                <option value="hot" <?php echo ($spice == 'hot') ? 'selected' : ''; ?>>เผ็ด</option>
                                <option value="extra_hot" <?php echo ($spice == 'extra_hot') ? 'selected' : ''; ?>>เผ็ดมาก</option>
                            </select>
                        </div>

                        <div class="filter-group">
                            <label class="filter-label">ราคาสูงสุด (฿)</label>
                            <input type="number" 
                                   name="max_price" 
                                   class="filter-input" 
            ...
            <div class="results-header">
                <div class="results-count">
                    พบ <strong><?php echo count($menus); ?></strong> เมนู
                            ...
                            <div class="menu-content">
                              ...
                              <?php endif; ?>
                                ...
                                <p class="menu-description">
                                    <?php echo htmlspecialchars($menu['description'] ?: 'อาหารไทยเพื่อสุขภาพ'); ?>
                                </p>
                                ...
                                <div class="menu-tags">
                                    ...
                                    <?php if ($menu['spice_level']): ?>
                                        <span class="spice-tag spice-<?php echo $menu['spice_level']; ?>">
                                            ...
                                            <?php echo $spice_labels[$menu['spice_level']] ?? 'กลาง'; ?>
                                        </span>
                                    <?php endif; ?>
                                </div>
            ...
            <?php if (!empty($menus)): ?>
                <div class="cta-section" style="text-align: center; padding: 3rem 0; background: var(--cream); border-radius: var(--radius-lg); margin-top: 3rem;">
                    <h2 style="font-size: 1.8rem; font-weight: 700; color: var(--text-dark); margin-bottom: 1rem;">
                        พร้อมเริ่มต้นการกินแบบสุขภาพแล้วหรือยัง?
                    </h2>
                    <p style="font-size: 1.1rem; color: var(--text-gray); margin-bottom: 2rem; max-width: 600px; margin-left: auto; margin-right: auto;">
                        เลือกแพ็คเกจอาหารที่เหมาะกับคุณ และเริ่มต้นการดูแลสุขภาพด้วยอาหารไทยต้นตำรับ
                    </p>
    ...
    <div id="menuModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">รายละเอียดเมนู</h3>
    ...
    <footer style="background: var(--text-dark); color: var(--white); padding: 2rem 0; text-align: center; margin-top: 4rem;">
        <div class="container">
            ...
            <p style="color: var(--text-gray); margin-bottom: 0.5rem;">
                อาหารไทยเพื่อสุขภาพ ส่งถึงบ้านคุณ
            </p>
            <p style="color: var(--text-gray); font-size: 0.9rem;">
                © 2025 Krua Thai. สงวนลิขสิทธิ์.
            </p>
        </div>
    </footer>
            ...
            return `
                <div style="text-align: center; margin-bottom: 2rem;">
                    ...
                    <div style="font-size: 1.3rem; font-weight: 700; color: var(--curry);">
                        ฿${parseFloat(menu.base_price).toLocaleString()}
                    </div>
                </div>

                <div style="margin-bottom: 2rem;">
                    <h4 style="font-weight: 600; margin-bottom: 0.8rem; color: var(--text-dark);">รายละเอียดเมนู</h4>
                    <p style="color: var(--text-gray); line-height: 1.6;">
                        ${menu.description || 'อาหารไทยเพื่อสุขภาพ'}
                    </p>
                </div>

                ${menu.ingredients ? `
                    <div style="margin-bottom: 2rem;">
                        <h4 style="font-weight: 600; margin-bottom: 0.8rem; color: var(--text-dark);">ส่วนประกอบ</h4>
                        <p style="color: var(--text-gray); line-height: 1.6;">
                            ${menu.ingredients}
                        </p>
                    </div>
                ...
                <div style="margin-bottom: 2rem;">
                    <h4 style="font-weight: 600; margin-bottom: 1rem; color: var(--text-dark);">ข้อมูลโภชนาการ</h4>
                ...
                ${dietaryTags.length > 0 ? `
                    <div style="margin-bottom: 2rem;">
                        <h4 style="font-weight: 600; margin-bottom: 0.8rem; color: var(--text-dark);">ประเภทอาหาร</h4>
                ...
                ${menu.spice_level ? `
                    <div style="margin-bottom: 2rem;">
                        <h4 style="font-weight: 600; margin-bottom: 0.8rem; color: var(--text-dark);">ระดับความเผ็ด</h4>
                        <div style="display: inline-flex; align-items: center; gap: 0.5rem; background: var(--cream); padding: 0.6rem 1rem; border-radius: 25px;">
                            ...
                            <span style="font-weight: 600; color: var(--curry);">
                                ${spiceLabels[menu.spice_level] || 'กลาง'}
                            </span>
                        </div>
                    </div>
                ` : ''}
                ...
                ${healthBenefits.length > 0 ? `
                    <div style="margin-bottom: 2rem;">
                        <h4 style="font-weight: 600; margin-bottom: 0.8rem; color: var(--text-dark);">ประโยชน์ต่อสุขภาพ</h4>
