...
<head>
    ...
    <title>Dashboard - Krua Thai | อาหารไทยเพื่อสุขภาพ</title>
    <meta name="description" content="จัดการการสมัครสมาชิก สั่งอาหาร และติดตามสถานะของคุณ">
...
<body>
    ...
    <header>
        <nav>
            ...
            <ul class="nav-links" id="navLinks">
                ...
                <li><a href="menus.php">เมนูทั้งหมด</a></li>
                <li><a href="meal-selection.php">สั่งอาหาร</a></li>
                <?php if ($active_subscription): ?>
                    <li><a href="meal-planner.php">วางแผนอาหาร</a></li>
                <?php endif; ?>
                <li><a href="order-history.php">ประวัติออเดอร์</a></li>
            </ul>
            ...
            <div class="user-menu">
                ...
                <div class="user-profile" onclick="toggleUserMenu()">
                    ...
                    <div class="user-info">
                        ...
                        <span><?php echo $user_role === 'admin' ? 'ผู้ดูแลระบบ' : 'สมาชิก'; ?></span>
                    </div>
                ...
                <div class="dropdown" id="userDropdown">
                    ...
                    <a href="subscription-status.php"><i class="fas fa-calendar-alt"></i> สมาชิก</a>
                    <a href="order-history.php"><i class="fas fa-history"></i> ประวัติออเดอร์</a>
                    <a href="settings.php"><i class="fas fa-cog"></i> ตั้งค่า</a>
                    <?php if ($user_role === 'admin'): ?>
                        <a href="admin/dashboard.php"><i class="fas fa-shield-alt"></i> ผู้ดูแลระบบ</a>
                    <?php endif; ?>
    ...
    <main class="main-content">
        ...
        <section class="welcome-section loading">
            <div class="welcome-content">
                <div class="welcome-text">
                    <h1>สวัสดี, <?php echo htmlspecialchars($user_name); ?>! 👋</h1>
                    <p>ยินดีต้อนรับสู่ Krua Thai - อาหารไทยเพื่อสุขภาพส่งถึงบ้านคุณ</p>
                </div>
                <div class="quick-stats">
                    <div class="stat-item">
                        <div class="stat-number"><?php echo count($recent_orders); ?></div>
                        <div class="stat-label">ออเดอร์ล่าสุด</div>
                    </div>
                    <?php if ($active_subscription): ?>
                        <div class="stat-item">
                            <div class="stat-number"><?php echo $active_subscription['meals_per_week']; ?></div>
                            <div class="stat-label">มื้อ/สัปดาห์</div>
                        </div>
                    <?php endif; ?>
                    <div class="stat-item">
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card loading">
                <div class="card-header">
                    <h3 class="card-title">สมาชิกปัจจุบัน</h3>
                    <?php if ($active_subscription): ?>
                        <a href="subscription-status.php" class="card-action">จัดการ</a>
                    <?php endif; ?>
                </div>
                ...
                <?php if ($active_subscription): ?>
                    <div class="subscription-status">
                        <span class="status-badge status-<?php echo $active_subscription['status']; ?>">
                            <?php echo $active_subscription['status'] === 'active' ? 'ใช้งานอยู่' : 'หยุดชั่วคราว'; ?>
                        </span>
                    </div>
                    <div class="subscription-info">
                        <h4><?php echo htmlspecialchars($active_subscription['plan_name_thai'] ?? $active_subscription['plan_name']); ?></h4>
                        <p><?php echo $active_subscription['meals_per_week']; ?> มื้อต่อสัปดาห์</p>
                        <?php if ($active_subscription['next_billing_date']): ?>
                            <p>ชำระครั้งถัดไป: <?php echo date('d/m/Y', strtotime($active_subscription['next_billing_date'])); ?></p>
                        <?php endif; ?>
                    </div>
                    <div style="display: flex; gap: 1rem; margin-top: 1rem;">
                        <a href="meal-planner.php" class="btn btn-primary btn-sm">วางแผนอาหาร</a>
                        <a href="subscription-status.php" class="btn btn-secondary btn-sm">จัดการสมาชิก</a>
                    </div>
                <?php else: ?>
                    <div class="empty-state">
                        <i class="fas fa-calendar-plus"></i>
                        <h4>ยังไม่มีสมาชิก</h4>
                        <p>เริ่มต้นการกินอาหารเพื่อสุขภาพวันนี้</p>
                        <a href="subscribe.php" class="btn btn-primary btn-sm">เลือกแพ็กเกจ</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="dashboard-card loading">
                <div class="card-header">
                    <h3 class="card-title">ออเดอร์ล่าสุด</h3>
                    <a href="order-history.php" class="card-action">ดูทั้งหมด</a>
                </div>
                    ...
                    <?php foreach (array_slice($recent_orders, 0, 3) as $order): ?>
                        <div class="order-item">
                            <div class="order-info">
                                <h5>ออเดอร์ #<?php echo htmlspecialchars($order['order_number']); ?></h5>
                                <p><?php echo $order['item_count']; ?> รายการ • <?php echo date('d/m/Y', strtotime($order['created_at'])); ?></p>
                            </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>เริ่มสั่งอาหารอร่อยๆ กันเลย</p>
                        <a href="menus.php" class="btn btn-primary btn-sm">ดูเมนู</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="dashboard-card featured-meals loading">
                <div class="card-header">
                    <h3 class="card-title">เมนูแนะนำ - สั่งด่วน</h3>
                    <a href="menus.php" class="card-action">ดูทั้งหมด</a>
                </div>
                        ...
                        <?php foreach ($featured_meals as $meal): ?>
                            <div class="meal-card">
                                ...
                                <div class="meal-info">
                                    ...
                                    <?php endif; ?>
                                    <h4><?php echo htmlspecialchars($meal['name_thai'] ?? $meal['name']); ?></h4>
                                    <div class="meal-price">฿<?php echo number_format($meal['base_price'], 0); ?></div>
                                    <a href="meal-selection.php?single=<?php echo $meal['id']; ?>" class="btn btn-primary btn-sm" style="width: 100%;">สั่งเลย</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                <?php else: ?>
                    <div class="empty-state">
                        <i class="fas fa-utensils"></i>
                        <h4>ไม่มีเมนูแนะนำ</h4>
                        <p>เมนูอาหารกำลังเตรียมอยู่</p>
                        <a href="menus.php" class="btn btn-primary btn-sm">ดูเมนูทั้งหมด</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <?php if (!$active_subscription && !empty($subscription_plans)): ?>
            <section id="subscription-plans" class="dashboard-card loading">
                <div class="card-header">
                    <h3 class="card-title">เลือกแพ็กเกจสมาชิก</h3>
                    <span class="card-action" style="color: var(--text-gray);">เริ่มต้นเพียง ฿599/สัปดาห์</span>
                </div>
                
                <div class="plans-grid">
                    <?php foreach ($subscription_plans as $plan): ?>
                        <div class="plan-card <?php echo $plan['is_popular'] ? 'featured' : ''; ?>">
                            <h4 class="plan-name"><?php echo htmlspecialchars($plan['name_thai'] ?? $plan['name']); ?></h4>
                            <div class="plan-price">
                                ฿<?php echo number_format($plan['final_price'], 0); ?>
                                <span>/สัปดาห์</span>
                            </div>
                            <div class="plan-meals"><?php echo $plan['meals_per_week']; ?> มื้อต่อสัปดาห์</div>
                            <a href="meal-selection.php?plan=<?php echo $plan['id']; ?>" class="btn btn-primary btn-sm">เลือกแพ็กเกจนี้</a>
                        </div>
                    <?php endforeach; ?>
                </div>
            </section>
        ...
        <?php if (!empty($notifications)): ?>
            <section class="dashboard-card loading">
                <div class="card-header">
                    ...
                    <a href="notifications.php" class="card-action">ดูทั้งหมด</a>
                </div>
    ...
    <script>
        ...
        function toggleNotifications() {
            ...
            <?php if (!empty($notifications)): ?>
                alert('คุณมีการแจ้งเตือน <?php echo count($notifications); ?> รายการ');
            <?php else: ?>
