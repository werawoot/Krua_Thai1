                            ...
                            <tr data-order-id="<?= $order['id'] ?>">
                                ...
                                <td>
                                    <div style="display: flex; gap: 0.5rem;">
                                        <button class="btn btn-icon btn-info btn-sm" onclick="viewOrderDetails('<?= $order['id'] ?>')" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-icon btn-warning btn-sm" onclick="editOrder('<?= $order['id'] ?>')" title="Edit Order">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn btn-icon btn-success btn-sm" onclick="printOrder('<?= $order['id'] ?>')" title="Print">
