        ...
        <div class="container">
            ...
            <div class="dashboard-header">
                <div class="dashboard-welcome">
                    <h1>สวัสดี, <?php echo htmlspecialchars($user['first_name']); ?>! 👋</h1>
                    <p>ยินดีต้อนรับสู่แดชบอร์ดของคุณ - จัดการการสมัครสมาชิกและติดตามสุขภาพของคุณ</p>
                </div>
            </div>
            ...
            <div class="stats-section">
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-label">แพ็กเกจที่ใช้งาน</div>
                    </div>
                    <div class="stat-card">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-label">เป้าหมายโภชนาการ</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number"><?php echo $notification_count ?? 0; ?></div>
                        <div class="stat-label">การแจ้งเตือนใหม่</div>
                    </div>
                </div>
            </div>
                ...
                <div class="dashboard-main">
                    ...
                    <section>
                        <div class="empty-state">
                            ...
                            <h3>ยินดีต้อนรับสู่ Krua Thai!</h3>
                            <p>คุณได้เข้าสู่ระบบเรียบร้อยแล้ว เริ่มต้นการใช้งานได้เลย</p>
                            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                                <a href="subscription-plans.php" class="btn-primary">เลือกแพ็กเกจ</a>
                                <a href="menus.php" class="btn-secondary">ดูเมนู</a>
                            </div>
                        </div>
                    </section>
                ...
                <div class="dashboard-sidebar">
                    ...
                    <div class="sidebar-card">
                        ...
                        <div class="quick-actions">
                            <a href="subscribe.php" class="action-button">
                                ...
                                <span class="action-text">เลือกแพ็กเกจใหม่</span>
                            </a>
                            <a href="edit_profile.php" class="action-button">
                                <span class="action-icon">👤</span>
                                <span class="action-text">แก้ไขโปรไฟล์</span>
                            </a>
                            <a href="menus.php" class="action-button">
                                <span class="action-icon">🍽️</span>
                                <span class="action-text">ดูเมนูทั้งหมด</span>
                            </a>
                            <a href="nutrition-tracking.php" class="action-button">
                                <span class="action-icon">📊</span>
                                <span class="action-text">ติดตามโภชนาการ</span>
                            </a>
                        </div>
                    ...
                    <div class="sidebar-card">
                        ...
                        <div style="line-height: 1.8;">
                            ...
                            <p><strong>Email:</strong> <?php echo htmlspecialchars($user['email']); ?></p>
                            <p><strong>สถานะ:</strong> <span style="color: var(--success);">✅ ออนไลน์</span></p>
                    ...
                    <div class="sidebar-card">
                        ...
                        <p>หากมีปัญหาในการใช้งาน สามารถติดต่อทีมงานได้</p>
                        <div style="margin-top: 1rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
                            <a href="help.php" class="btn-secondary">ศูนย์ช่วยเหลือ</a>
                        </div>
                    </div>
                </div>
            </div>
